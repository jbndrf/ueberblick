...
class FormBuilder {
    ...
    showQuestionModal(existingField = null) {
        console.log('showQuestionModal called', existingField);
        ...
        console.log('About to render question form');
        
        let questionFormHTML;
        try {
            questionFormHTML = this.renderQuestionForm(existingField);
            console.log('Question form rendered successfully');
        } catch (error) {
        ...
        console.log('Modal element found:', addedModal);
            ...
            <div class="field-summary-card" data-field-id="${field.id}">
                <div class="field-summary-header">
                    ...
                    <div class="field-summary-actions">
                        <button type="button" class="btn-icon btn-edit" onclick="formBuilder.editQuestion('${field.id}')" title="Edit Question">✏️</button>
                        <button type="button" class="btn-icon btn-copy" onclick="formBuilder.copyQuestion('${field.id}')" title="Copy Question">📋</button>
                        <button type="button" class="btn-icon btn-remove" onclick="formBuilder.removeQuestion('${field.id}')" title="Remove Question">🗑️</button>
                    </div>
                </div>
        ...
        return `
            <div class="simple-question-card" data-field-id="${field.id}">
                ...
                <div class="simple-question-actions">
                    <button type="button" class="btn-simple-action btn-edit" onclick="formBuilder.editFieldInOverlay('${field.id}')" title="Edit Question">⚙️</button>
                    <button type="button" class="btn-simple-action btn-copy" onclick="formBuilder.copyFieldSimple('${field.id}')" title="Copy Question">📋</button>
                    <button type="button" class="btn-simple-action btn-remove" onclick="formBuilder.removeFieldSimple('${field.id}')" title="Remove Question">🗑️</button>
                </div>
            </div>
        `;
    }

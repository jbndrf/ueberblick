<script lang="ts">
	...
	import { workflowBuilderStagePanelStage } from '$lib/paraglide/messages';
...
<div class="panel">
	<div class="panel-header bg-muted border-b border-border">
		...
		<div class="panel-header-text">
			...
			<span class="panel-header-subtitle text-muted-foreground">{context.stage.data.stageType} {(workflowBuilderStagePanelStage?.() ?? 'stage')}</span>
		</div>
	</div>

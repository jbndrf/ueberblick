<script lang="ts">
	...
	import {
		formEditorSmartDropdownMappingDone,
		formEditorSmartDropdownMappingHint,
		formEditorSmartDropdownMappingNoOptions,
		formEditorSmartDropdownMappingOptionsLabel,
		formEditorSmartDropdownMappingPlaceholder,
		formEditorSmartDropdownMappingSourceField,
		formEditorSmartDropdownMappingTitle
...
<Dialog.Root bind:open onOpenChange={handleOpenChange}>
	<Dialog.Content class="smart-dropdown-modal">
		...
		<Dialog.Footer>
			<Button onclick={handleDone}>{formEditorSmartDropdownMappingDone?.() ?? 'Done'}</Button>
		</Dialog.Footer>
	</Dialog.Content>
</Dialog.Root>

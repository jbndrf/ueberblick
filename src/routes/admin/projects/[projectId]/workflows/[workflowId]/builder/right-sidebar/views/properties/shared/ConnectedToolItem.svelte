<script lang="ts">
	...
	import { propertiesConnectedToolItemDeleteTool } from '$lib/paraglide/messages';
...
<div class="connected-tool-item">
	...
	<div class="tool-actions" onclick={(e) => e.stopPropagation()}>
		...
		/>
		{#if onDelete}
			<button class="delete-btn" type="button" onclick={onDelete} title={propertiesConnectedToolItemDeleteTool?.() ?? 'Delete tool'}>

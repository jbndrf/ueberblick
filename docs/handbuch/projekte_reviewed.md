...
- **Marker-Kategorien** sind statische Punkte auf der Karte, die unabhaengig von Workflows existieren -- etwa Standorte von Hydranten, Notausgaenge oder Sammelplaetze. Jede Kategorie hat ein eigenes Icon und eigene Farben. Workflow-Eintraege (Maengel, Begehungen etc.) erscheinen ebenfalls als Marker, erhalten ihr Aussehen aber ueber die Workflow-Einstellungen, nicht ueber Marker-Kategorien.

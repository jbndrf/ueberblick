...
Ein Formular-Tool zeigt dem Teilnehmer ein [Formular](formulare.md) an und speichert die eingegebenen Daten. Sie koennen es an Verbindungen oder Stufen anhaengen.
